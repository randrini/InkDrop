...
LOCAL_CHECKS = (
    ...
    ("backup_archive_import_restore_smoke", 60, [sys.executable, "-B", "inkdrop-backup-archive-import-restore-smoke.py"]),
    ("backup_restore_decompression_bomb_smoke", 60, [sys.executable, "-B", "inkdrop-backup-restore-decompression-bomb-smoke.py"]),
    ("backup_archive_resource_exhaustion_smoke", 60, [sys.executable, "-B", "inkdrop-backup-archive-resource-exhaustion-smoke.py"]),
    ...
    ("opds_smoke", 60, [sys.executable, "-B", "inkdrop-opds-smoke.py"]),
    ...
    ("diagnostic_artifacts_smoke", 60, [sys.executable, "-B", "inkdrop-diagnostic-artifacts-smoke.py"]),
    ...
    ("slskd_root_health_smoke", 60, [sys.executable, "-B", "inkdrop-slskd-root-health-smoke.py"]),
    ...
    ("source_query_coverage_smoke", 60, [sys.executable, "-B", "inkdrop-source-query-coverage-smoke.py"]),
    ...
    ("prowlarr_api_url_normalization_smoke", 60, [sys.executable, "-B", "inkdrop-prowlarr-api-url-normalization-smoke.py"]),
    ...
    ("cover_proxy_redirect_safety_smoke", 60, [sys.executable, "-B", "inkdrop-cover-proxy-redirect-safety-smoke.py"]),
    ...
    ("notification_delivery_skip_status_smoke", 60, [sys.executable, "-B", "inkdrop-notification-delivery-skip-status-smoke.py"]),
    ...
    ("reading_order_prefix_import_smoke", 60, [sys.executable, "-B", "inkdrop-reading-order-prefix-import-smoke.py"]),
    ("slskd_completed_transfer_truth_smoke", 60, [sys.executable, "-B", "inkdrop-slskd-completed-transfer-truth-smoke.py"]),
    ("source_worker_execution_evidence_smoke", 60, [sys.executable, "-B", "inkdrop-source-worker-execution-evidence-smoke.py"]),
)

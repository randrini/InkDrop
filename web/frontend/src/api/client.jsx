...
api.state = {
  ...
  seriesLibrary: (id, params) => api.get(`/api/inkdrop-state/series/library?id=${encodeURIComponent(id)}${queryStr(params)}`),
  seriesLibraryPreview: (id, params) => api.get(`/api/inkdrop-state/series/library/preview?id=${encodeURIComponent(id)}${queryStr(params)}`),
...
api.diagnostics = {
  ...
  readerFrontendOrphanCleanupApply: (body) => api.post('/api/inkdrop-diagnostics/reader-frontend-orphan-cleanup/apply', body),
  ...
  managedLibraryDuplicatesQuarantine: (body) => api.post('/api/inkdrop-diagnostics/managed-library-duplicates/quarantine', body),
};

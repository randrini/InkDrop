    ...
    try:
        rows = con.execute(
            ...
            select q.id as queue_id, q.state as queue_state, q.current_source,
                   ...
                   s.kapowarr_id, s.raw_json as series_raw_json,
    ...
    trusted_identity = inkdrop_manual_search.trusted_target_unit_identity(
        {
            ...
            "series_manga_unit_override": inkdrop_manga_unit_policy.series_manga_unit_override(
                {"raw_json": row.get("series_raw_json")}
            ),
        }
    )
...
# Shared with inkdrop_source_providers' _indexer_* copies -- see inkdrop_bencode.
bdecode_value = inkdrop_bencode.bdecode_value
torrent_dict_get = inkdrop_bencode.torrent_dict_get
torrent_text = inkdrop_bencode.torrent_text
torrent_path_text = inkdrop_bencode.torrent_path_text

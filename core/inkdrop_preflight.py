...
CONFIG_ENV_KEYS = (
    ...
    "INKDROP_LOCK_DIR",
    "INKDROP_LOG_DIR",
    "INKDROP_LOG_ROTATION_MAX_BYTES",
    "INKDROP_LOG_RETENTION_FILES",
    "INKDROP_LOG_RETENTION_DAYS",
    "INKDROP_LOG_RETENTION_WRITER_GRACE_SECONDS",
    "INKDROP_LOG_ROTATION_QUIET_SECONDS",
    "INKDROP_LOG_ROTATION_SAMPLE_MILLISECONDS",
    "INKDROP_CACHE_DIR",
    "INKDROP_BACKUP_DIR",
    "INKDROP_STAGING_DIR",
    ...
    "INKDROP_SCHEDULER_LOG_RETENTION_INTERVAL_SECONDS",
...
INTEGER_ENV_RULES = {
    ...
    "INKDROP_LOG_ROTATION_MAX_BYTES": (1048576, 1073741824),
    "INKDROP_LOG_RETENTION_FILES": (1, 50),
    "INKDROP_LOG_RETENTION_DAYS": (1, 3650),
    "INKDROP_LOG_RETENTION_WRITER_GRACE_SECONDS": (3601, 604800),
    "INKDROP_LOG_ROTATION_QUIET_SECONDS": (0, 86400),
    "INKDROP_LOG_ROTATION_SAMPLE_MILLISECONDS": (1, 5000),
    "INKDROP_SCHEDULER_QUEUE_MAINTENANCE_INTERVAL_SECONDS": (1, 604800),
    "INKDROP_SCHEDULER_QUEUE_MAINTENANCE_TIMEOUT_SECONDS": (60, 1800),
    "INKDROP_SCHEDULER_LOG_RETENTION_INTERVAL_SECONDS": (60, 604800),
    "INKDROP_SCHEDULER_LOG_RETENTION_TIMEOUT_SECONDS": (30, 600),
